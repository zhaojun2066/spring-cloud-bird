package com.bird.cloud.seata.example.order.server.dao;

import com.bird.cloud.seata.example.order.server.entity.MallOrder;
import com.bird.cloud.seata.example.order.server.entity.MallOrderExample;
...
public interface MallOrderMapper {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    int batchInsert(@Param("list") List<MallOrder> list);
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    int batchInsertSelective(@Param("list") List<MallOrder> list, @Param("selective") MallOrder.Column... selective);
}